...
In other words, the *<span style="color:white; background-color:gray">below</span>* is handled by the cloud and being used by itself would give the customer full control of the operating environment.
