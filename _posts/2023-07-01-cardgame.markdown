...
> To see a preview of this project go to [Shuffling Cards on Codespaces](https://vigilant-adventure-p9wg57vrxq9275w6.github.dev/) and select the `index.html` file and then `go live` on the status bar.
